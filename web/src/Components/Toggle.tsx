...
export function ViewerToggle (props: { toggleFn: () => void, active: boolean }): JSX.Element {
  return (
...
export function ClearToggle (props: { clearFn: () => void }): JSX.Element {
  return (
...
export function GoToLobbyToggle (): JSX.Element {
